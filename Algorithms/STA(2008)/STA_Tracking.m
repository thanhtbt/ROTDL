function [Factor_Es,PER_Sum] = STA_Tracking(X_cell,tucker_rank,OPTS)
...
[T,S] = STA(X_cell{1,1},tucker_rank);
alpha = 1;
for t = 2 : L
    
    Xt      = X_cell{t,1};
    [T,S]   = STA(Xt,tucker_rank,T,S,alpha);
